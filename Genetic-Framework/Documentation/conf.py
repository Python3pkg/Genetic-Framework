...
latex_documents = [
  ('index', 'Genetic.tex', 'Genetic Documentation',
...
man_pages = [
    ('index', 'genetic', 'Genetic Documentation',
...
texinfo_documents = [
  ('index', 'Genetic', 'Genetic Documentation',
   'Ashwin Panchapakesan', 'Genetic', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_copyright = '2012, Ashwin Panchapakesan'
